...
else if (inputs[2].value>=today.getFullYear() && inputs[1].value>(today.getMonth())+1) {
    ps[1].innerHTML="Must be in the past";  
    labels[1].style.color = "hsl(0, 100%, 67%)";
    inputs[1].style.borderColor="hsl(0, 100%, 67%)";
    validMonth= 0;     
    }
else if (inputs[2].value>=today.getFullYear() && inputs[1].value>=today.getMonth()+1 && inputs[0].value>today.getDate()) {
...
if (inputs[2].value>0 && inputs[2].value<=999) {  //=0
...
if (Number(d) !== Number(day)) {             //check if day was in this month (30 of February?)
...
function myYears() {
   ...
   else {return today.getFullYear()-inputs[2].value}
}
...
else if (month>today.getMonth()+1 && Number(day)<=today.getDate()) { //-1 year
...
else {return month-today.getMonth()-1;}};  //-1year
...
function myDays() {
   ...
   if (Number(day)<=today.getDate()) {return today.getDate()-Number(day);}
   else {return lastDayNumber-Number(day)+today.getDate()}
}
